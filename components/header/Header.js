...
import Logo from '/public/images/logo/logo-cakici-coban.png'
            ...
            <div className="wpo-site-header bg-[#272c3f] relative ">
                <div className="wraper">
                    <div className="flex items-center justify-between ">
                        ...
                        <div className="flex flex-row logo w-[255px] md:w-[200px] md:mx-auto sm:w-[180px] col:w-[160px]">
                            <Link onClick={ClickHandler} className="text-[45px] col:text-[25px] font-bold flex items-center text-white" href="/">
                                <Image src={Logo} alt="" width={48} height={48}/></Link>
                            <h1 className=" text-2xl text-cc-gold block">Çakıcı & Çoban</h1>
                        </div>
